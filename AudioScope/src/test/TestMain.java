...
public class TestMain {
	...
	private static final byte[] CONNECT_HEADER = new byte[] { 0x07, 0x08, 0x01, 0x00,(byte) 0x0E, 0x49, 0x00};
	...
	private static final int TIMEOUT = 1000000; //5000;
	...
	public static void main(String[] args) throws Exception{
		...
		ByteBuffer header = read(handle, 4096);
		header.position(12);
